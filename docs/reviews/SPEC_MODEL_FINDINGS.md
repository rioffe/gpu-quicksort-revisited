...
> - **Scope:** 88 spec ids: 46 proven (kernel-checked), 41 deferred to named §9 tests, 1 excluded (O-1, retired).
...
- **No unwitnessed requirement.** Every one of the 41 deferred ids, and every "process side" half of a proven id, names the §9 tests that carry it.
